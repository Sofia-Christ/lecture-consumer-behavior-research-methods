...
\begin{section}{Sampling}

    \paragraph{Target Group/ Population} Every study has a subset of the population it is focused on, and eventually can make assumptions about.
...
\end{section}
\begin{section}{Statistical analysis of data}
    ...
    \begin{tabular}{ l c c c }
        ...
        Example
        & \includegraphics{../assets/symetric-box-plot.png} 
        & \includegraphics{../assets/left-skewes-box-plot.png}
        & \includegraphics{../assets/right-skewes-box-plot.png}  \\
...
\end{section}
\begin{section}{Bivariate statistical analysis}
